(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('rxjs/Observable'), require('rxjs/Subject'), require('rxjs/add/operator/map'), require('rxjs/add/operator/do'), require('rxjs/add/operator/filter'), require('rxjs/add/operator/delay'), require('rxjs/add/operator/first'), require('rxjs/add/operator/toPromise'), require('rxjs/add/operator/publish'), require('rxjs/add/observable/of'), require('rxjs/add/observable/race'), require('rxjs/add/observable/throw'), require('rxjs/add/operator/catch')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/common/http', 'rxjs/Observable', 'rxjs/Subject', 'rxjs/add/operator/map', 'rxjs/add/operator/do', 'rxjs/add/operator/filter', 'rxjs/add/operator/delay', 'rxjs/add/operator/first', 'rxjs/add/operator/toPromise', 'rxjs/add/operator/publish', 'rxjs/add/observable/of', 'rxjs/add/observable/race', 'rxjs/add/observable/throw', 'rxjs/add/operator/catch'], factory) :
	(factory((global['angular-oauth2-oidc'] = {}),global.core,global.common,global.http,global.Observable,global.Subject));
}(this, (function (exports,core,common,http,Observable,Subject) { 'use strict';
...
var OAuthService = (function (_super) {
    ...
    function OAuthService(http$$1, storage, tokenValidationHandler, config, urlHelper) {
         ...
         */
        _this.state = '';
        _this.eventsSubject = new Subject.Subject();
        _this.discoveryDocumentLoadedSubject = new Subject.Subject();
    ...
    OAuthService.prototype.silentRefresh = function (params) {
        ...
        */
        ...
        var /** @type {?} */ timeout = Observable.Observable.of(new OAuthErrorEvent('silent_refresh_timeout', null))
    ...
    OAuthModule.forRoot = function (config) {
        ...
        return {
            ...
            providers: [
                ...
                { provide: http.HTTP_INTERCEPTORS, useClass: DefaultOAuthInterceptor, multi: true }
            ]
        };
    };
    return OAuthModule;
